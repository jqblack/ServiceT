...
function ejecutar() {
    ...
    $("#salvar").click(function () {
        ...
        if (validaciones() == true) {
            ...
            json_header_array.f_tipo_recibo='NCC';
            json_header_array.f_nota=$("#comentario").val();
            ...
            $.ajax({
                type: "POST",
                url: window.location + '/salvar_nota_credito',
                data: vector,
...
function validaciones() {
    ...
    if ($("#id_cliente").val() == '') {
        ...
        notificacion_no('Digite una Nota');
        //$("#nota").focus();
        valor = false;
                  ...
                  //  filterable: true,
                   // pageable: true,
                    ...
                    columns: [
                        ...
                        {text: 'A Pagar', filtertype: 'textbox', datafield: 'f_a_pagar', width: "20%",cellsalign: 'right',cellsformat: 'c2' },
            ...
            $("#tabla_datos").jqxGrid(
                {
                    ...
                    columns: [
                        ...
                        {text: 'Vencimiento', filtertype: 'textbox', datafield: 'f_vencimiento', width: "15%"},
                        {text: 'Monto', filtertype: 'textbox', datafield: 'f_monto', width: "10%",cellsalign: 'right',cellsformat: 'c2' },
                        {text: 'Balance', filtertype: 'textbox', datafield: 'f_balance', width: "15%",cellsalign: 'right',cellsformat: 'c2' },
                        {text: 'A Pagar', filtertype: 'textbox', datafield: 'f_a_pagar', width: "15%",cellsalign: 'right',cellsformat: 'c2' },
                        {text: 'Concepto', filtertype: 'textbox', datafield: 'f_concepto', width: "10%",cellsalign: 'right',cellsformat: 'c2' },
                        {text: 'Abonar', datafield: 'f_abonar', columntype: 'button', cellsrenderer: function () {
                            return 'Abonar';
                        },buttonclick: function (row) {

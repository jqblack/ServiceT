                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group ">
                                ...
                                <input type="email" id="parametro"    class="form-control" placeholder="Parametro Busqueda">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group ">
...
<asset:javascript src="js_proyecto/procesos/ver_facturas.js"/>
<g:javascript>

...
<div class="page-header">
    ...
    <div class="row">
        ...
        <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-money page-header-icon"></i>&nbsp;&nbsp;Nota De Credito</h1>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-0 col-sm-0 col-xl-0 col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group has-feedback">
                                            ...
                                            <textarea type="" id="comentario"  class="form-control" placeholder="Comentario" ></textarea>
                                            %{--<span class="fa fa-envelope form-control-feedback"></span>--}%
                                        </div>
                                    </div>
...
<asset:javascript src="js_proyecto/procesos/nota_credito.js"/>
<g:javascript>

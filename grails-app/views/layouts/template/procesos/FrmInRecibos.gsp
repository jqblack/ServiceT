...
<div class="page-header">
    ...
    <div class="row">
        ...
        <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-money page-header-icon"></i>&nbsp;&nbsp;Recibos</h1>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 col-xl-12 col-lg-2">
                                        ...
                                        <div class="form-group has-feedback">
                                            <label>Saldo Deu.</label>
                                            <input type="" readonly id="sald_deudor" class="form-control" placeholder="Saldo" required>
                                            %{--<span class="fa fa-envelope form-control-feedback"></span>--}%
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xl-12 col-lg-2">
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="" readonly id="monto_recibo" class="form-control" placeholder="Monto" required>
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xl-12 col-lg-2">
                                        ...
                                        <div class="form-group has-feedback">
                                            <label>A Pagar</label>
                                            <input type="" id="a_pagar" class="form-control" placeholder="A Pagar" required>
                                            %{--<span class="fa fa-envelope form-control-feedback"></span>--}%
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-0 col-sm-0 col-xl-0 col-lg-1">
                                        <div class="form-group has-feedback">
                                            <label>&nbsp;</label>
                                            <button type="submit" id="ver_estado_cuenta" class="btn btn-success"><span class="fa fa-folder"></span>&nbsp;Estado Cuenta</button>
...
<asset:javascript src="js_proyecto/procesos/recibos.js"/>
<g:javascript>

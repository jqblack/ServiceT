    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <input type="text" hidden value="${tusuario.id}" id="idUsuario">
                ...
                <div class="panel-footer text-right">
                    ...
                    %{--</span>--}%
                    <button class="btn btn-info btn-flat" id="nuevo">Nuevo</button>
                    <button class="btn btn-primary btn-flat" id="salvar">Salvar</button>
                </div>
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <span class="panel-title">Archivos cargados.</span>
...
<asset:javascript src="js_proyecto/registros/ticket_adm.js"/>
<g:javascript>

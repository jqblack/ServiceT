...
<asset:javascript src="js_proyecto/tickets/asignar_tickets.js"/>
...
<%
    }else
    {
        ...
        if(map.get("f_status").toString() as Long ==4)
        {
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <ul class="search-classic tab-pane fade in active" >
                    <li style="text-align:center;background: #EAEEFB;font-size: 20px;font-weight: bold">
                        <p>Este Ticket ya fue asignado a un tecnico</p>
                    </li>
                </ul>
                        ...
                        <ul class="search-classic tab-pane fade in active" id="search-tabs-all">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <span class="floatR">
                                                    <button class="btn btn-success" type="button" data-toggle="modal" data-target="#modal_asignar">Asignar</button>
                            ...
                            <li class="" style="list-style: none;">
                                ...
                                <%
                                    ...
                                    {
                                %>
                                <form action="${getRequest().getContextPath()}/descargarUpdate" method="post" target="_blank">
                    ...
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            ...
                            <div  class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Tecnico :</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group has-feedback">
                                            ...
                                            <select id="tipo_tk" class="form-control form-group-margin">
                                                <option value="0">--Seleccione--</option>
                                                <%
                                                    for (Map<String,java.lang.Object> map_tipo : lista_tipo_tickets){

                                                %>
                                                <option  value="${map_tipo.get("f_idrecord")}">${map_tipo.get("f_descripcion")} </option>
                                                <%
                                                    }
                                                %>
                                            </select>
                                ...
                                <g:javascript>
                                   set_broadcast(${map.get("f_broadcast")});
                                </g:javascript>
